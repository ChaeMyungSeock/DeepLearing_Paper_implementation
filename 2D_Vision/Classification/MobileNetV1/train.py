...
from mobilenet_utill.acc_matrix import *
from mobilenet_utill.custom_data_load import *

import torch
import torch.nn as nn
import torch.nn.functional as F
from torch.utils.data import DataLoader
from MobileNet_model.MobileNet import *
from torchvision import datasets, transforms
import argparse
import torch.optim as optim
import torchvision.models as models
from mobilenet_utill.CustomDataset import CustomImageDataset
...
if __name__ == '__main__':
    ...
    custom_model = MobileNet(n_classes=num_classes, alpha=1.0).to(device)

    # pre_mobilenet = models.mobilenet_v1(pretrained=True)
