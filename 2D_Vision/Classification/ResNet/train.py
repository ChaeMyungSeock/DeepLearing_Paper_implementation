...
from Resnet_utill.acc_matrix import *
from Resnet_utill.CustomDataset import *
...
if __name__ == '__main__':
    ...
    custom_model = resnet101(n_classes=num_classes).to(device)
    ...
    for e in range(hyper_param_epoch):
        ...
        if best_acc < (100 * correct / total):
            ...
            torch.save(custom_model, f'{round((100 * correct / total),2)}_ResNetnet.pth')
