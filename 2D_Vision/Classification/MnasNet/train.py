...
from MnasNet_utill.acc_matrix import *
from MnasNet_utill.custom_data_load import *

import torch
import torch.nn as nn
import torch.nn.functional as F
from torch.utils.data import DataLoader
from MnasNet_model.MnasNet import *
...
from MnasNet_utill.CustomDataset import CustomImageDataset
...
model_urls = {
    "MNASNet1_0_Weights": "https://download.pytorch.org/models/mnasnet1.0_top1_73.512-f206786ef8.pth",
}
...
if __name__ == '__main__':
    ...
    custom_model = MnasNet(n_classes=num_classes).to(device)

    pre_mobilenet = models.mnasnet1_0(pretrained=True)
    state_dict = load_state_dict_from_url(model_urls['MNASNet1_0_Weights'], progress=True)
